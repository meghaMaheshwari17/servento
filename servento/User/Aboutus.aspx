<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterSerivece.Master" AutoEventWireup="true" CodeBehind="Aboutus.aspx.cs" Inherits="As_Your_Need_services.User.WebForm21" %>
                        ...
                        <div class="row d-flex flex-wrap align-items-center a-b-none">
                            ...
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="section-head">
                                    ...
                                    <h2 class="sf-title">Book Service With Servento</h2>
                                    <p>Today, Servento announced the creation of its new brand, Servento . The new umbrella brand captures the company’s ambition to be a horizontal gig marketplace, with a global footprint and leadership position across service categories, Beauty & Wellness and Home Repairs & Maintenance.

Servento  was launched in Delhi in November 2014 with a handful of service professionals. Over the past 5 years, it has expanded to India, built a fleet of 25,000+ trained professionals and served over 5 million households.

Looking towards the future, the Servento  is clear about its vision – To empower millions of professionals world-wide deliver services at home like never experienced before.

With the new brand, Servento  takes a step closer towards this vision. The new brand encapsulates the company’s strategy to offer multiple types of services at home: like Beauty , cleaning , electricion , Plumbing , Gardening , Painter etc.. </p>
                                </div>
                                <!--Title Section End-->
                            </div>
                        </div>
                    ...
                    <div class="section-content">
                       <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <h2 class="sf-title">How SERVENTO Works</h2>
                            </div>
                            <!--Title Section End-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 m-b30">
                                            <div class="aon-step-section step-position-1 aon-icon-effect">
                                                ...
                                                <div class="aon-step-info">
                                                    <h4 class="aon-title">Register Yourself</h4>
                                        ...
                                        <div class="col-md-4 col-sm-4 m-b30">
                                            <div class="aon-step-section step-position-2 aon-icon-effect">
                                                ...
                                                <div class="aon-step-info">
                                                    <h4 class="aon-title">Choose a Service</h4>
                                                    <%--<p>This helps us determine which Taskers are abest job.</p>--%>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 m-b30">
                                            <div class="aon-step-section  step-position-3  aon-icon-effect">
                                                ...
                                                <div class="aon-step-info">
                                                    <h4 class="aon-title">Book The Service</h4>
                                                    <%--<p>This helps us determine which Taskers are abest job.</p>--%>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="row d-flex flex-wrap align-items-center a-b-none">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <div class="section-head">
                                    ...
                                    <h2 class="sf-title">Trusted by thousands of people all over the India</h2>
                                            ...
                                            <div class="media-bg-animate media-statics aon-icon-effect">
                                                <div class="aon-static-section aon-t-blue">
                                                    <div class="aon-company-static-num counter aon-icon">
                                                        <asp:Label ID="lblprovider" runat="server" Text=""></asp:Label></div>
                                                    <div class="aon-company-static-name">Vendor</div>
                                                </div>
                                            </div>
                                            <div class="media-bg-animate media-statics aon-icon-effect">
                                                <div class="aon-static-section aon-t-yellow">
                                                    <div class="aon-company-static-num counter aon-icon">
                                                        <asp:Label ID="lblstaff" runat="server" Text=""></asp:Label></div>
                                                    <div class="aon-company-static-name">Staff</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 m-b30 aon-static-position-2">
                                            <div class="media-bg-animate media-statics aon-icon-effect">
                                                <div class="aon-static-section aon-t-green">
                                                    <div class="aon-company-static-num counter aon-icon"> <asp:Label ID="lblcust" runat="server" Text=""></asp:Label></div>
